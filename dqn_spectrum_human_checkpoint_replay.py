...
if args.mode == 'train':
    ...
    checkpoints = [join('checkpoints', str(name)) for name in range(11)]    
    dqn.fit(env, callbacks=callbacks, nb_steps=1750000, log_interval=10000, starting_checkpoints=checkpoints)
